...
class HotelsBNBPage extends StatefulWidget {
  const HotelsBNBPage({Key? key}) : super(key: key);

  @override
  State<HotelsBNBPage> createState() => _HotelsBNBPageState();
}

class _HotelsBNBPageState extends State<HotelsBNBPage> {
  @override
  void initState() {
    super.initState();
